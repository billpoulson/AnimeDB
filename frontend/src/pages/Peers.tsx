            ...
            <>
              ...
              {!networking.remotelyManaged && (
                <div className="flex items-start gap-3">
                  <span className="text-sm text-gray-400 w-28 shrink-0 pt-0.5">UPnP</span>
                    ...
                    {networking.externalUrl && (
                      <div className="text-xs flex items-center gap-1">
                        {networking.connectable ? (
                          <>
                            <span className="text-green-400">Connectable:</span>
                          ...
                          <span className="text-gray-500">Connectable: No</span>
                        )}
                      </div>
                    )}
                  </div>
